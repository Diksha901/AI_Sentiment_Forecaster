        ...
        <DashboardLayout title="Insights Dashboard">
            ...
            <div className="space-y-8">
                ...
                <div className="relative group">
                    ...
                    <input
                        type="text"
                        placeholder="Search for a product, service, or competitor trend..."
                    ...
                    />
                    <button className="absolute right-3 top-3 bottom-3 px-10 bg-primary text-background-dark font-black rounded-2xl hover:brightness-110 active:scale-95 transition-all shadow-xl shadow-primary/20">
                        Analyze
                    </button>
                </div>
            </div>
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-16 relative z-10">
                        <div className="relative flex items-center justify-center p-4">
                            <svg className="w-48 h-48 transform -rotate-90">
                                ...
                                <circle
                                    ...
                                    strokeDasharray={552.92} strokeDashoffset={552.92 * (1 - 0.78)}
                        ...
                        <div className="flex-1 w-full space-y-8">
                            {[
                                { label: 'Positive', value: 78, color: 'bg-primary' },
                                { label: 'Neutral', value: 15, color: 'bg-slate-500' },
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-lg font-bold leading-relaxed opacity-90 italic">
                            "Wireless Earbuds' show significant interest in battery longevity and noise-cancelling tech. Customer satisfaction is peaking around ergonomic design."
                        </p>
                    </div>
