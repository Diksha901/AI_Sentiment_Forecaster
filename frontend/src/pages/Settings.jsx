...
//                                 /> 
//                         </div>
//                             <button className="px-6 py-3 bg-white/5 border border-white/10 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-white/10 transition-all"  onClick={handleChangePassword}>Change Password</button>
//                         </div>
//                         <div className="p-8 flex items-center justify-between hover:bg-white/[0.01] transition-colors">
//                             <div>
...
//                             </div>
//                             <button className="px-6 py-3 bg-rose-500/10 text-rose-500 border border-rose-500/20 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-rose-500/20 transition-all" onClick={()=>toggleSetting('twoFactorEnabled')}>{settings.twoFactorEnabled ? 'Disable' : 'Enable'}</button>
//                         </div>
//                     </div>
//                 </section>
...
//                         {[
//                             { label: 'Email Alerts', desc: 'Weekly trend summaries and account activity.', checked: settings.emailAlerts, onToggle: () => setSettings(prev => ({...prev,emailAlerts: !prev.emailAlerts})) },
//                             { label: 'System Updates', desc: 'Get notified about new features and scheduled maintenance.',  checked: settings.systemUpdates, onToggle: () => setSettings(prev => ({...prev, systemUpdates: !prev.systemUpdates}))  }
//                         ].map((item) => (
...
//                                     <p className="text-slate-400 mt-2 text-lg">{settings.price}</p>
//                                 </div>
...
//                                 <select value={settings.plan}
//                                     onChange={e => setSettings(prev => ({ ...prev, plan: e.target.value }))}
//                                 >
...
//                                         <p className="font-bold text-lg">Visa ending in {settings.cardLast4}</p>
//                                         <p className="text-sm text-slate-500">Expires {settings.cardExpiry}</p>
//                                     </div>
